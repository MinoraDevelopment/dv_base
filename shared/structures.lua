Config.Structures = {
    ...
    ['campfire'] = {
        ...
        zOffset = -0.6, durability = 100, buildTime = 3000, snapLength = nil,
    ...
    ['large_tent'] = {
        label = 'Großes Basis-Zelt', category = 'camp', model = 'xm3_prop_xm3_tent_01a',
    ...
    ['wooden_fence'] = {
        ...
        zOffset = -0.05, durability = 120, buildTime = 4000, snapLength = 2.0,
    ...
    ['concrete_wall'] = {
        ...
        materials = { { item = 'stone', amount = 20 } },
        hasStash = false, isGate = false, isCraftingBench = false, isPowerSource = false,
